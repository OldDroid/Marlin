...
#define STRING_CONFIG_H_AUTHOR "(Alexander Pohl, Ender 3 Pro)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  28.28,  28.28 }
    #define DEFAULT_Ki_LIST {   2.94,   2.94 }
    #define DEFAULT_Kd_LIST {  68.02,  68.02 }
  #else
    // Creality Ender 3 Pro - MicroSwiss All Metal Hotend
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 99.04 }
